...
def train_one_epoch(model, train_loader, criterion, optimizer, scheduler, device, epoch_num):
    ...
    part_accuracy = {part: 100 * part_correct[part] / part_total[part] 
                    for part in part_total}
...
def main():
    ...
    model = EnhancedEnsemble(num_classes=num_classes).to(device)
    ...
    for epoch in range(epochs):
        ...
        for part in val_part_acc:
            ...
            if best_part_accs and val_part_acc[part] > best_part_accs[part]:
        ...
        if val_acc > best_val_acc:
            ...
            }, os.path.join(os.path.dirname(train_dir), 'enhanced_ensemble_best.pth'))
